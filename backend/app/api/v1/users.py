...
async def get_controllers(db: AsyncSession = Depends(get_db)):
    """Get all controllers with their assigned employees."""
...
async def get_user_by_id(
    *,
    ...
    """Get a user by ID with their relationships."""
...
async def get_user_by_email(
    *,
    ...
    """Get a user by email with their relationships."""
...
async def assign_controller_to_employee(
    *,
    ...
    """Assign a controller to an employee."""
    try:
...
async def get_employees_by_controller(
    *,
    ...
    """Get all employees assigned to a specific controller."""
